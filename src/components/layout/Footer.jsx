          ...
          <div>
            ...
            <ul className="space-y-4">
              {footerLinks.liensUtiles.map((link) => (
                <li key={link.name}>
                  <a href={link.href} className="text-slate-500 hover:text-[#633BBC] transition-colors">
                    {link.name}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              {footerLinks.support.map((link) => (
                <li key={link.name}>
                  <a href={link.href} target="_blank" className="text-slate-500 hover:text-[#633BBC] transition-colors">
                    {link.name}
                  </a>
                </li>
              ))}
...
const SocialIcon = ({ Icon, href }) => (
  ...
  >
    <Icon className="w-5 h-5 text-slate-500 group-hover:text-[#633BBC] transition-colors" />
  </a>
);
